...
function Navbar() {
  ...
  return (
    <nav className='flex items-center justify-between flex-wrap p-5 bg-primary sticky top-0 shadow'>


      {/* Header Logo */}
      <Link to='/' className='flex items-center text-xl font-semibold flex-shrink-0 text-golden mr-6 lg:mr-72 '>
        Sea Jewels
      </Link>
